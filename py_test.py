...
def test_email(self):
    ...
    # * Valid Test cases
    assert ur.check_email_format("abc@yahoo.com"),"should be valid"
    assert ur.check_email_format("abc-100@yahoo.com"),"should be valid"
    assert ur.check_email_format("abc.100@yahoo.com"),"should be valid"
    assert ur.check_email_format("abc111@abc.com"),"should be valid"
    assert ur.check_email_format("abc111@abc.net"),"should be valid"
    assert ur.check_email_format("abc.100@abc.com.au"),"should be valid"
    assert ur.check_email_format("abc@1.com"),"should be valid"
    assert ur.check_email_format("abc@gmail.com.com"),"should be valid"
    assert ur.check_email_format("abc+100@gmail.com"),"should be valid"

    # ! Invalid Test cases
    assert not ur.check_email_format("abc.@com"),"should not be valid"
    assert not ur.check_email_format("abc@.com.my"),"should not be valid"
    assert not ur.check_email_format("abc123@gmail.a"),"should not be valid"
    assert not ur.check_email_format("abc123@.com.com"),"should not be valid"
    assert not ur.check_email_format(".abc@abc.com"),"should not be valid"
    assert not ur.check_email_format("abc()*@gmail.com"),"should not be valid"
    assert not ur.check_email_format("abc@%*.com"),"should not be valid"
    assert not ur.check_email_format("abc..2002@gmail.com"),"should not be valid"
    assert not ur.check_email_format("abc.@gmail.com"),"should not be valid"
    assert not ur.check_email_format("aabc@abc@gmail.com"),"should not be valid"
    assert not ur.check_email_format("aabc@gmail.com.1a"),"should not be valid"
    assert not ur.check_email_format("abc@gmail.com.aa.au"),"should not be valid"
